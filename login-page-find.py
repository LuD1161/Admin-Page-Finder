...
from bs4 import BeautifulSoup       # If you are using Beautiful Soup 4 beta use this , To get everything

#from BeautifulSoup import BeautifulSoup    # If you are using Beautiful Soup 3 , remove the first hashtag
            ...
            try:
                ...
                if m:
                    ...
                    if (ans=='N'):
                        ...
                        print('No. of links checked '+count)
                        break;
                #print(res.info())      -- For Server Response Printing
                #print(data)
                res.close()
